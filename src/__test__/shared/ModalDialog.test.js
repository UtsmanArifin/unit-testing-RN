...
describe('Modal Dialog', () => {
    ...
    test('Successfully auto close', () => {
        const ModalTestHelper = () => {
            ...
            return(
                <View>
                    <ModalDialog visible={modalVisible} onClose={() => setModalVisible(false)}><Text>Dummy Modal</Text></ModalDialog>
                </View>
            )
        }
        ...
        fireEvent.press(viewPressable, 'Press');
        // expect(screen.getByText(/Dummy/)).toBeFalsy();
    })
})